 ...
 *
 * Generated on Mon Oct 23 11:28:14 2017
 ...
 */
typedef uint_fast8_t gs_can_crc_8_t;


/**
 * Static table used for the table_driven implementation.
 */
static const gs_can_crc_8_t gs_can_crc_8_table[256] = {
 ...
 */
static inline gs_can_crc_8_t gs_can_crc_8_init(void)
{
    return 0x77;
}
 ...
 */
//crc_8_t crc_8_update(crc_8_t crc, const void *data, size_t data_len);
static inline gs_can_crc_8_t gs_can_crc_8_update(gs_can_crc_8_t crc, const void *data, size_t data_len)
{
    ...
    while (data_len--) {
        tbl_idx = crc ^ *d;
        crc = (gs_can_crc_8_table[tbl_idx] ^ (crc >> 8)) & 0xff;
        d++;
    }
    return crc & 0xff;
}
 ...
 */
static inline gs_can_crc_8_t gs_can_crc_8_finalize(gs_can_crc_8_t crc)
{
    return crc;
}
